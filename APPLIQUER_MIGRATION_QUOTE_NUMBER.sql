...
-- ============================================
-- 
-- Cette migration crée un trigger pour générer automatiquement
-- le numéro de devis au format "ANNEE-NNN" (ex: 2026-001)
-- ============================================
...
-- ============================================
-- Testez en créant un devis et vérifiez que le quote_number est généré :
-- INSERT INTO quotes (project_id, artisan_id, amount, status) 
-- VALUES ('votre-project-id', 'votre-artisan-id', 10000, 'pending')
