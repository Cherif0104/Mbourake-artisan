-- Migration: Quand une révision est acceptée, mettre à jour le projet en quote_accepted
-- L'artisan n'a pas les droits UPDATE sur projects (RLS) ; le trigger contourne cela.
