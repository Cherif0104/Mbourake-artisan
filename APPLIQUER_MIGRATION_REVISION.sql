-- ============================================
-- MIGRATION : Création de la table quote_revisions
-- ============================================
...
-- ============================================
-- Exécutez cette requête pour vérifier que la table a été créée :
-- SELECT table_name FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'quote_revisions';
